      ...
      {isOpen && (
        ...
        >
          ...
          <button
            ...
            className={`w-full flex items-center gap-2 px-4 py-2 text-left transition-all duration-200 cursor-pointer ${
          ...
          {/* Separator */}
          <div className="h-px bg-gh-border-default my-2" />

          {/* Collections List */}
          {collections.map((collection, index) => {
            const isFirstUserCollection = index > 0 &&
              collections[index - 1].isSystemCollection &&
              !collection.isSystemCollection;

            return (
              <React.Fragment key={collection.id}>
                {isFirstUserCollection && (
                  <div className="h-px bg-gh-border-default my-2" role="separator" />
                )}
                <div
                  ...
                  className={`w-full flex items-center gap-2 px-4 py-2 transition-all duration-200 cursor-pointer ${
          ...
          {isCreating ? (
            <form onSubmit={handleCreateCollection} className="px-4 py-2">
              <input
                type="text"
            ...
            <button
              ...
              className="w-full flex items-center gap-2 px-4 py-2 text-gh-accent-fg hover:bg-gh-accent-subtle/30 transition-all duration-200 cursor-pointer"
            >
              <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
